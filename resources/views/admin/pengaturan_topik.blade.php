...
<head>
    ...
    <title>InfoTA - Pengaturan Topik</title>
    ...
    <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: #881d1d;">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link active" href="/admin/pengaturan_topik"><i class="fas fa-cogs"></i><span>Pengaturan Topik</span></a></li>
                ...
                <li class="nav-item"><hr><a class="nav-link" href="/admin/profil"><i class="fas fa-user"></i><span>Profil</span></a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.simpan_pengaturan_topik') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" class="btn btn-primary" id="btn-tambah-bidang">Tambah Bidang</button>
