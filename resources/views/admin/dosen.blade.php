            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item dropdown active">
                        <a class="dropdown-toggle nav-link active" aria-expanded="false" data-bs-toggle="dropdown" href="#"><i class="fas fa-users"></i><span>Kelola Pengguna</span></a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Dosen</h3>
                    </div>

                    <div class="card shadow mb-4" style="border-radius: 18px;">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center" style="border-radius: 18px 18px 0 0;">
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('dosen.tambah') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input class="form-control form-control-sm @error('kode_dosen') is-invalid @enderror" type="text" name="kode_dosen" placeholder="Ex: KYI">
                        ...
                        <div class="card-body p-4" style="background: #fff; border-radius: 0 0 18px 18px; box-shadow: 0 2px 16px rgba(136,29,29,0.08);">
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-striped table-hover align-middle" id="tableData" style="border-radius: 12px; overflow: hidden; background: #fafbfc;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" role="dialog" tabindex="-1" id="ModalHapusDosenPembimbing{{$data->id}}">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" style="font-weight: bold;">Hapus Dosen Pembimbing</h5>
                                                                <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                ...
                                                <div class="modal fade" role="dialog" tabindex="-1" id="ModalLihatDosenPembimbing{{$data->id}}">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" style="font-weight: bold;">Lihat Dosen Pembimbing</h5>
                                                                <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body">
