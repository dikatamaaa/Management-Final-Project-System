...
<head>
    ...
    <title>Tambah Aspek Rubrik Penilaian - infoTA</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    ...
                    <h4 class="text-dark mb-0">Tambah Aspek Rubrik Penilaian</h4>
                </div>
                <form action="{{ route('dosen.rubrik-penilaian.store') }}" method="POST">
                    @csrf
                    <div class="mb-2">
                        <label>Tipe Aspek</label>
                        <select name="tipe" class="form-select" required>
                            <option value="individu">Individu (per anggota)</option>
                            <option value="kelompok">Kelompok (satu nilai untuk kelompok)</option>
                        </select>
                    </div>
                    <div class="mb-2">
                        <label>CD</label>
                        <input type="number" name="cd" class="form-control" min="1" required>
                    </div>
                    <div class="mb-2">
                        <label>Aspek</label>
                    ...
                    <div class="mb-2">
                        ...
                        @for($i=0;$i<=4;$i++)
                            <input type="text" name="indikator[{{ $i }}]" class="form-control mb-1" placeholder="Indikator skor {{ $i }}" required>
                        @endfor
                    </div>
                    <div class="mb-2">
