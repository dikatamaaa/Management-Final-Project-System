...
<head>
    ...
    <title>Rubrik Penilaian Dosen - infoTA</title>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($aspek->indikator as $skor => $label)
                                        <div><b>{{ $skor }}:</b> {{ $label }}</div>
                                    @endforeach
                                </td>
                                <td>{{ $aspek->bobot }}</td>
                                <td>{{ $aspek->urutan }}</td>
                                <td>
                                    <a href="{{ route('dosen.rubrik-penilaian.edit', $aspek->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="{{ route('dosen.rubrik-penilaian.destroy', $aspek->id) }}" method="POST" style="display:inline">
                                        @csrf @method('DELETE')
                                        <button class="btn btn-sm btn-danger" onclick="return confirm('Hapus aspek ini?')">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
